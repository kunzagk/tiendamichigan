...
export const createUser = async (id, nombre, email, password) => await genericSqlQuery('INSERT INTO usuarios (id, nombre, email, password) VALUES (DEFAULT ,$1, $2, $3) RETURNING *;', [nombre, email, password])
